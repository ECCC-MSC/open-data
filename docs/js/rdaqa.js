...
// Async function used to retrieve start, end, and default time from RDAQA_10km_PM10 layer GetCapabilities document
async function getRadarStartEndTime() {
  let response = await fetch('https://geo.weather.gc.ca/geomet/?lang=en&service=WMS&request=GetCapabilities&version=1.3.0&LAYERS=RDAQA_10km_PM10&t=' + new Date().getTime())
...
let layers = [
    ...
    new ol.layer.Image({
      source: new ol.source.ImageWMS({
        ...
        params: {'LAYERS': 'RDAQA_10km_PM10', 'TILED': true},
