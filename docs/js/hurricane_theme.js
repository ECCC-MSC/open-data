...
// Async function used to retrieve start, end, and default time from HRDPS-WEonG_2.5km_WindGust layer GetCapabilities document
async function getRadarStartEndTime() {
  let response = await fetch('https://geo.weather.gc.ca/geomet/?lang=en&service=WMS&request=GetCapabilities&version=1.3.0&LAYERS=HRDPS-WEonG_2.5km_WindGust&t=' + new Date().getTime())
...
let map = new ol.Map({
  ...
  layers: layers,
  view: new ol.View({
    center: ol.proj.fromLonLat([-90, 46.7]),
    zoom: 3.5
  })
});
