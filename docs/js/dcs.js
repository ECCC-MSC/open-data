...
async function getRadarStartEndTime() {
  let response = await fetch('https://geo.weather.gc.ca/geomet-climate/?lang=en&service=WMS&request=GetCapabilities&version=1.3.0&LAYERS=DCS.PR.RCP26.YEAR.2021-2040_PCTL50')
