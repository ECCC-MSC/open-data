...
Le SRPOG est basé sur le modèle glace-océan NEMO-CICE et produit quotidiennement des analyses régionales de la glace de mer et de l'océan ainsi que des prévisions de 84 heures basées sur [00, 06, 12, 18] UTC sur un sous-ensemble de la grille tripolaire globale à résolution 1/12° (ORCA12).
