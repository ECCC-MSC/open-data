...
Cette page décrit les données d'indice de risque de submersion côtière [Submersion côtière](readme_coastal-flooding-risk-index_fr.md) en format GeoJSON disponibles sur le Datamart du SMC.
