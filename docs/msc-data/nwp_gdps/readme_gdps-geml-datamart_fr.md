...
Le Global Environnemental éMuLateur (GEML) est une composante du [Système global de prévision déterministe expérimental (SGPD)](readme_gdps_fr.md#donnees-du-systeme-global-de-prevision-deterministe-experimental)...... A COMPLÉTER
