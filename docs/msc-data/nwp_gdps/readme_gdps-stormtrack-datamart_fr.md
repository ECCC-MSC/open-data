...
# Données de trajectoires de tempêtes générées à partir du Système global de prévision déterministe
...
* [https://dd.meteo.gc.ca/today/model_gdps/storm-tracks/{HH}/](https://dd.meteo.gc.ca/today/model_gdps/storm-tracks)
...
* Cyclone tropicaux: `{YYYYMMDD}T{HH}Z_MSC_GDPS-StormTracks_TropicalCyclone_PT{hhh}H.json`
* Cyclones extra-tropicaux:
...
* Cyclone tropicaux: `{YYYYMMDD}T{HH}Z_MSC_GDPS-Analysis[48H,96H]-StormTracks_TropicalCyclone_PT{hhh}H.json`
* Cyclones extra-tropicaux:
...
* __GDPS-Analysis[48H,96H]-StormTracks__ : Chaîne de caractères constante indiquant des analyses 48h ou 96h de trajectoires de tempêtes générées à partir du Système global de prévision déterministe (GDPS en anglais)
...
* `20251016T12Z_MSC_GDPS-StormTracks_TropicalCyclone_PT048H.json`
* `20251012T12Z_MSC_GDPS-Analysis48H-StormTracks_GradientWindVorticity-IsbL-0500_PT024H.json` : analyse générée à 20251014T12Z (20251012T12Z + 48H) correspondant à la prévision de 20251013T12Z (20251012T12Z + PT024H).
