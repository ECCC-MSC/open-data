...
* [Données disponibles via les services web géospatiaux GeoMet-Météo](../../msc-geomet/readme_fr.md), notamment via GeoMet-OGC-API, avec la collection expérimentale [Prévisions météorologiques par ville en temps réel](https://api.meteo.gc.ca/collections/citypageweather-realtime?lang=fr)
