...
* __LVL__ : Valeur du niveau vertical [10m, 0.5m, 1.5m, 2m: pour les niveaux AGL; 0.025m, 0.075m, 0.15m, 0.3m, 0.7m, 1.5m, 2.5m: pour les niveaux DBS; `0-2 m` de la surface à 2 mètres]. Ce paramètre est absent pour la surface
