...
*  Remplacement de la prévision actuelle de l'onde de tempête basée sur l'ajustement sinusoïdal par un signal d'onde de tempête plus réaliste prévu par le système régional de prévision des ondes de tempête d'ensemble (SRPEOT) pour calculer la condition limite en aval 
