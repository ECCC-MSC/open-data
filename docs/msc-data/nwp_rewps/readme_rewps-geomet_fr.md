...
Exemple de carte interactive présentant la couche [REWPS-Great-Lakes - Direction moyenne de la houle](https://geo.weather.gc.ca/geomet?service=WMS&version=1.3.0&request=GetCapabilities&lang=fr&layer=REWPS-Great-Lakes_2.5km_PeakWaveDir_01) du SRPEV provenant de GeoMet du SMC :

<div id="map" style="height: 400px; position: relative">
  <div id="legend-popup">
  <div id="legend-popup-content">
    <img id="legend-img" style="display: flex; max-width: 85px;" src="https://geo.weather.gc.ca/geomet?lang=fr&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=REWPS-Great-Lakes_2.5km_PeakWaveDir_01&format=image/png&STYLE="/>
  </div>
</div>
</div>
...
Pour savoir quelles couches du SRPEV sont servies par GeoMet du SMC, consultez le [document WMS GetCapabilities](https://geo.weather.gc.ca/geomet?service=WMS&version=1.3.0&request=GetCapabilities&lang=f).
...
* Exemple d'une requête pour récupérer une légende : [https://geo.weather.gc.ca/geomet?version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=REWPS-Great-Lakes_2.5km_PeakWaveDir_01&format=image/png&STYLE=RAQDPS-WDIR6-LINEAR](https://geo.weather.gc.ca/geomet?version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=REWPS-Great-Lakes_2.5km_PeakWaveDir_01&format=image/png&STYLE=WDIR6-LINEAR).

![La légende WDIR6-LINEAR sur la couche REWPS-Great-Lakes_2.5km_PeakWaveDir_01](https://geo.weather.gc.ca/geomet?version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=REWPS-Great-Lakes_2.5km_PeakWaveDir_01&format=image/png&STYLE=WDIR6-LINEAR)
