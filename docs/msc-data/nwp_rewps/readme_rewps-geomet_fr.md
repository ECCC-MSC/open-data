...
<div id="map" style="height: 400px; position: relative">
  ...
  <div id="legend-popup-content">
    <img id="legend-img" src="https://geo.weather.gc.ca/geomet?lang=fr&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=REWPS-Great-Lakes_2.5km_PeakWaveDir_01&format=image/png&STYLE="/>
  </div>
</div>
</div>
