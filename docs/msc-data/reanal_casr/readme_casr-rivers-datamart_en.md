...
__Gridded statistical products__ derived from the Canadian Surface Reanalysis - Rivers (CaSR-Rivers) can be found at:
...
__Aggregate statistical products by watershed__, derived from the Canadian Surface Reanalysis - Rivers (CaSR-Rivers), can be found at:

* [https://dd.weather.gc.ca/today/reanalysis_casr/casr-rivers/{Version}/post-processing/watersheds/{polygon_dataset}/area{nb}](https://dd.weather.gc.ca/today/reanalysis_casr/casr-rivers/)
