[En français](readme_bulletins_fr.md)
...
* [Data (non-georeferenced) available on the GeoMet-OGC-API geospatial web services](https://api.weather.gc.ca/collections/bulletins-realtime)
