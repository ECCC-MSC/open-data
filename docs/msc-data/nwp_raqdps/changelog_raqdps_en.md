...
[TOC](../../readme_en.md) > [MSC data](../readme_en.md) > [RAQDPS](readme_raqdps_en.md) > RAQDPS Changelog
...
* The grid is rotated to correspond to the new RDPS 5.0.0 grid (see [description of changes](/../nwp_rdps/changelog_rdps_en.md)).
