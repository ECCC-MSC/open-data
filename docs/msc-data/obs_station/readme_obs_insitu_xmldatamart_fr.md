...
* [https://dd.meteo.gc.ca/today/observations/xml/{PC}/{TYPE}](https://dd.meteo.gc.ca/today/observations/xml)
...
* Pour qu'un record soit affiché, il doit y avoir au moins 15 années de données dans la base de données des archives climatiques tel que  mentionné sur leur site : [http://climate.meteo.gc.ca/historical_data/search_historic_data_f.html](http://climate.meteo.gc.ca/historical_data/search_historic_data_f.html)
