[In English](readme_aqhi-geomet_en.md)


![ECCC logo](../../img_eccc-logo.png)


[TdM](../../readme_fr.md) > [Données du SMC](../readme_fr.md) > [CAS](readme_aqhi_fr.md) > CAS sur GeoMet du SMC
...
La couche CAS est disponible sur GeoMet-Météo par le biais des standards [WMS (Web Map Service)](../../msc-geomet/wms_fr.md) et [WCS (Web Coverage Service)](../../msc-geomet/wcs_fr.md).

Exemple de carte interactive présentant la couche [AQHI-OBS](https://geo.weather.gc.ca/geomet?service=WMS&version=1.3.0&request=GetCapabilities&lang=fr&layer=AQHI-OBS) du CAS provenant de GeoMet du SMC :

<div id="map" style="height: 400px; position: relative">
  <div id="legend-popup">
  <div id="legend-popup-content">
    <img id="legend-img" src="https://geo.weather.gc.ca/geomet?lang=fr&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=AQHI-OBS&format=image/png&STYLE=default"/>
  </div>
</div>
</div>
...
Pour connaître les détails de la couche CAS servie par GeoMet du SMC, consultez le [document WMS GetCapabilities](https://geo.weather.gc.ca/geomet?service=WMS&version=1.3.0&request=GetCapabilities&lang=f).
...
* Exemple d'une requête pour récupérer une légende :  [https://geo.weather.gc.ca/geomet?lang=fr&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=AQHI-OBS&format=image/png&STYLE=default](https://geo.weather.gc.ca/geomet?lang=fr&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=AQHI-OBS&format=image/png&STYLE=default).

![La légende par défault pour la couche AQHI-OBS](https://geo.weather.gc.ca/geomet?lang=fr&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=AQHI-OBS&format=image/png&STYLE=default)
