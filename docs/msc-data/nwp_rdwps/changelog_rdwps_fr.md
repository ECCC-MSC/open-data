[In English](changelog_rdwps_en.md)
...
### Mise à jour du SRPDV à la version 4.3.0 suite à la nouvelle infrastructure de calcul haute performance.
...
Un résumé des innovations incluses dans cette mise à jour ainsi que leurs impacts sur la performance du système est [disponible ici](https://collaboration.cmc.ec.gc.ca/cmc/cmoi/product_guide/docs/fact_sheets/factsheet_rdwps-420_f.pdf).
...
Un document avec des détails techniques à ce sujet est disponible [via ce lien](http://collaboration.cmc.ec.gc.ca/cmc/cmoi/product_guide/docs/tech_notes/technote_rdwps-420_f.pdf).
