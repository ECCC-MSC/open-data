...
During the post processing phase tidal heights are predicted using Webtide (Dupont et al., 2002). The linear summation of the tidal heights (SSHT) and surge forecast (ETAS) results in an estimate of the total water level (SSH).
