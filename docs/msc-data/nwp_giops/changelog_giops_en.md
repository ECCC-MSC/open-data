...
### Upgrade to Version 3.6.0 of the GIOPS adapted to the New High Performance Computing Infrastructure.
...
On Tuesday June 11, 2024, starting with the 1200 UTC run, the Meteorological Service of Canada's Canadian Meteorological Centre (CMC) will upgrade the Global Ice and Ocean Prediction System (GIOPS) to version 3.5.0.
