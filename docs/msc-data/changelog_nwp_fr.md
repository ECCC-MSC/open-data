...
* [Correction au contrôle de qualité des observations d'épaisseur de neige provenant des stations automatiques canadiennes dans le SGPE](nwp_geps/changelog_geps_fr.md#le-mardi-7-mars-2023)
* [Correction au contrôle de qualité des observations d'épaisseur de neige provenant des stations automatiques canadiennes dans le SGPD](nwp_gdps/changelog_gdps_fr.md#le-mardi-7-mars-2023)
* [Correction au contrôle de qualité des observations d'épaisseur de neige provenant des stations automatiques canadiennes dans le SRPD](nwp_rdps/changelog_rdps_fr.md#le-mardi-7-mars-2023)
...
Vous trouverez le détail de ces changements à  l'intérieur de la [note officielle](https://collaboration.cmc.ec.gc.ca/cmc/cmoi/product_guide/docs/lib/op_systems/doc_opchanges/genot_20040921_new_data_f.html).
