...
| LAYERS          | L'identifiant des couches à être affichées sur l'image. Pour de meilleures performances, il est recommandé de demander une couche par requête WMS. L'identifiant des couches est spécifié dans le résultat d'une requête [WMS GetCapabilities](#wms-getcapabilities)|
