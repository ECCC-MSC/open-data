...
Adding OGC API - Features data in QGIS :
...
Please refer to the section [OGC API - Features](../msc-geomet/web-services_en/#ogc-api-features) for more details on this standard.
