...
// Async function used to retrieve start, end, and default time from RDPA.24F_PR layer GetCapabilities document
...
function setTime() {
  if (currentTime >= endTime) {
    ...
    currentTime.setUTCMinutes(currentTime.getUTCMinutes() + 1440);
  }
  updateLayers();
  updateInfo();
}
