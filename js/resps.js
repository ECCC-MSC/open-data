...
async function getRadarStartEndTime() {
  let response = await fetch('https://geo.weather.gc.ca/geomet/?lang=en&service=WMS&request=GetCapabilities&version=1.3.0&LAYERS=RESPS-Atlantic-North-West_9km_StormSurge_01&t=' + new Date().getTime())
...
let layers = [
    ...
    new ol.layer.Image({
      source: new ol.source.ImageWMS({
        ...
        params: {'LAYERS': 'RESPS-Atlantic-North-West_9km_StormSurge_01', 'TILED': true},
...
let map = new ol.Map({
  ...
  layers: layers,
  view: new ol.View({
    center: ol.proj.fromLonLat([-62, 52]),
    zoom: 4.1
  })
});
