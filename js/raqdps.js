...
// Async function used to retrieve start, end, and default time from RAQDPS.SFC_NO2 layer GetCapabilities document
async function getRadarStartEndTime() {
  let response = await fetch('https://geo.weather.gc.ca/geomet/?lang=en&service=WMS&request=GetCapabilities&version=1.3.0&LAYERS=RAQDPS.SFC_NO2&t=' + new Date().getTime())
