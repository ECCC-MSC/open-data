...
// Async function used to retrieve start, end, and default time from HRDPS.CONTINENTAL_RT layer GetCapabilities document
async function getRadarStartEndTime() {
  let response = await fetch('https://geo.weather.gc.ca/geomet/?lang=en&service=WMS&request=GetCapabilities&version=1.3.0&HRDPS.CONTINENTAL_RT&t=' + new Date().getTime())
